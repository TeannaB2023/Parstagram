    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(caption.isEmpty()) {
                    Toast.makeText(getContext(), "Just come up with a caption", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (photoFile == null || ivPhoto.getDrawable() == null) {
                    Toast.makeText(getContext(), "Ummmmm image?", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e != null) {
                    ...
                    Toast.makeText(getContext(), "Post got messed up holdon", Toast.LENGTH_SHORT).show();
                }
