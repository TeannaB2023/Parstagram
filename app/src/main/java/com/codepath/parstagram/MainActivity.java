...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(caption.isEmpty()) {
                    Toast.makeText(MainActivity.this, "Just come up with a caption", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (photoFile == null || ivPhoto.getDrawable() == null) {
                    Toast.makeText(MainActivity.this, "Ummmmm image?", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void savePost(String caption, ParseUser currentUser, File photoFile) {
        Post post = new Post();
        post.setKeyDescription(caption);
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e != null) {
                    ...
                    Toast.makeText(MainActivity.this, "Post got messed up holdon", Toast.LENGTH_SHORT).show();
                }
